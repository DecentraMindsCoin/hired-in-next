...
const styles = {
  counter: ' bg-cyan-200 text-center h-56 flex relative',
  countVal: 'absolute top-1/3 w-full mx-auto text-4xl',
  buttons: 'flex justify-between w-full px-5 pt-40',
  incButton:
    'text-white uppercase font-bold rounded-full px-5 my-3 border-4 border-white shadow-cyan-400 shadow-xl bg-black',
}
const tw = styles
